...
public interface ISID2Types {
	...
	class sid2_config_t {
		...
		/**
		 * digi-boosted 8580 SID
		 */
		public boolean digiBoosted;

		/**
		 * enable SLDb (song length database)
		 */
		public boolean enableDatabase;

		/**
		 * SLDb (song length database)
		 */
		...
		/**
		 * STIL (SID tune information list) filename
		 */
		public String stil;
		 ...
		 * sampling method
		 */
		public sampling_method sampling;

		/**
		 * For play-back with CompareDriver: play original mp3 file.
		 */
		public boolean playOriginal;

		/**
		 * For play-back with CompareDriver: mp3 file name.
		 */
